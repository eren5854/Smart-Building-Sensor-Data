...
# 1. Dosyayı oku
dosya_adi = 'current_status_23_sali.csv'  # Kendi dosyanızın adını buraya yazın
...
window_size = 15  # 21 dakikalık bir pencere, yani 10 dakika öncesi ve 10 dakika sonrası dahil
...
yeni_dosya_adi = 'formated_current_status.csv'
